<%@ Control Language="C#" AutoEventWireup="true" CodeFile="DefaultSidebarProducts.ascx.cs" Inherits="DefaultSidebarProducts" %>
<%@ Import Namespace="Artisteer" %>
<%@ Register TagPrefix="artisteer" Namespace="Artisteer" %>
<%@ Register TagPrefix="art" TagName="DefaultVerticalMenu" Src="DefaultVerticalMenuProducts.ascx" %>
