<%@ Control Language="C#" AutoEventWireup="true" CodeFile="DefaultMenuProducts.ascx.cs" Inherits="DefaultMenuProducts" %>
...
<ul class="art-hmenu">
    ...
    <li><a href="IndexProducts.aspx" class=" active"><span class="l"></span><span class="r"></span><span class="t">Products</span></a></li>
