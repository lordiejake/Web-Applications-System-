<%@ Control Language="C#" AutoEventWireup="true" CodeFile="DefaultSidebarCategories.ascx.cs" Inherits="DefaultSidebarCategories" %>

<%@ Import Namespace="Artisteer" %>
<%@ Register TagPrefix="artisteer" Namespace="Artisteer" %>
<%@ Register TagPrefix="art" TagName="DefaultVerticalMenu" Src="DefaultVerticalMenuCategories.ascx" %>
