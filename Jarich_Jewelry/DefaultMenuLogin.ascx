<%@ Control Language="C#" AutoEventWireup="true" CodeFile="DefaultMenuLogin.ascx.cs" Inherits="DefaultMenuLogin" %>
...
<ul class="art-hmenu">
    ...
    <li><a href="IndexLogin.aspx" class=" active"><span class="l"></span><span class="r"></span><span class="t">Login
    </span></a></li>
...
<ul class="art-hmenu">
    ...
    <li><a href="Logout.aspx" class=" active"><span class="l"></span><span class="r"></span><span class="t">Logout
    </span></a></li>
