<%@ Control Language="C#" AutoEventWireup="true" CodeFile="DefaultMenuAdmin.ascx.cs" Inherits="DefaultMenuAdmin" %>
...
<ul class="art-hmenu">
    ...
    <li><a href="IndexAdmin.aspx" class=" active"><span class="l"></span><span class="r"></span><span class="t">Admin</span></a></li>
</ul>
</asp:Panel>
