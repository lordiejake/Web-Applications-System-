<%@ Control Language="C#" AutoEventWireup="true" CodeFile="DefaultSidebarAnnouncements.ascx.cs" Inherits="DefaultSidebarAnnouncements" %>
<%@ Import Namespace="Artisteer" %>
<%@ Register TagPrefix="artisteer" Namespace="Artisteer" %>
<%@ Register TagPrefix="art" TagName="DefaultVerticalMenu" Src="DefaultVerticalMenuAnouncements.ascx" %>
