<%@ Page Title="" Language="C#" MasterPageFile="~/design/MasterPage.master" AutoEventWireup="true" CodeFile="Admin-Control-Panel-Index-Promotions-Details-Panel.aspx.cs" Inherits="Admin_Control_Panel_Index_Promotions_Details_Panel" %>
...
<artisteer:Article ID="Article1" Caption="Promotions Details Panel" runat="server"><ContentTemplate>
    ...
    <artisteer:Article ID="Article2" Caption="Add new Promo" runat="server"><ContentTemplate>
    <br />

        <asp:Panel ID="CategoryExistsPanel" runat="server" Visible="False">
        <blockquote>
            <p>The Promotion name you entered already Exists</p>
        </blockquote>
        </asp:Panel>
        ...
        <table>
            <tr>
                ...
                <td>
                    <asp:TextBox ID="TxtPromoName" runat="server"></asp:TextBox><asp:RequiredFieldValidator
                        ID="RequiredFieldValidator1" runat="server" ControlToValidate = "TxtPromoName" ErrorMessage="*"></asp:RequiredFieldValidator>
                </td>      
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <asp:TextBox ID="TxtStartDate" runat="server"></asp:TextBox><asp:RequiredFieldValidator
                        ID="RequiredFieldValidator2" runat="server" ControlToValidate = "TxtStartDate" ErrorMessage="*"></asp:RequiredFieldValidator>
                </td>      
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <asp:TextBox ID="TxtEndDate" runat="server"></asp:TextBox><asp:RequiredFieldValidator
                        ID="RequiredFieldValidator3" runat="server" ControlToValidate = "TxtEndDate" ErrorMessage="*"></asp:RequiredFieldValidator>
                </td>      
            </tr>
            <tr>
                <td></td><td>
