<%@ Control Language="C#" AutoEventWireup="true" CodeFile="DefaultMenuContacts.ascx.cs" Inherits="DefaultMenuContacts" %>
<asp:Panel ID="PanelLogin" runat="server">
<ul class="art-hmenu">
    <li><a href="Default.aspx" ><span class="l"></span><span class="r"></span><span class="t">Home</span></a></li>
    <li><a href="IndexContacts.aspx" class=" active"><span class="l"></span><span class="r"></span><span class="t">Contacts</span></a>
        <!--ul>
