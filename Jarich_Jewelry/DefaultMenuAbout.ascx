<%@ Control Language="C#" AutoEventWireup="true" CodeFile="DefaultMenuAbout.ascx.cs" Inherits="DefaultMenuAbout" %>
...
<ul class="art-hmenu">
    ...
    <li><a href="IndexAbout.aspx" class=" active"><span class="l"></span><span class="r"></span><span class="t">About</span></a></li>
