<%@ Control Language="C#" AutoEventWireup="true" CodeFile="DefaultSidebarNews.ascx.cs" Inherits="DefaultSidebarNews" %>
<%@ Import Namespace="Artisteer" %>
<%@ Register TagPrefix="artisteer" Namespace="Artisteer" %>
<%@ Register TagPrefix="art" TagName="DefaultVerticalMenu" Src="DefaultVerticalMenuNews.ascx" %>
