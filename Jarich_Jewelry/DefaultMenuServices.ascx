<%@ Control Language="C#" AutoEventWireup="true" CodeFile="DefaultMenuServices.ascx.cs" Inherits="DefaultMenuServices" %>
...
<ul class="art-hmenu">
    ...
    <li><a href="IndexServices.aspx" class=" active"><span class="l"></span><span class="r"></span><span class="t">Services</span></a></li>
