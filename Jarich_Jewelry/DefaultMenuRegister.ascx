<%@ Control Language="C#" AutoEventWireup="true" CodeFile="DefaultMenuRegister.ascx.cs" Inherits="DefaultMenuRegister" %>
...
<ul class="art-hmenu">
    ...
    <li><a href="IndexRegister.aspx" class=" active"><span class="l"></span><span class="r"></span><span class="t">Register</span></a></li>
