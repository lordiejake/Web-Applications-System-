<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Poliomyelitis.aspx.cs" Inherits="Poliomyelitis" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Illness: Poliomyelitis</title>
		...
		<div class="post">
			...
			<div>
                        <asp:Label ID="lblViewMembers" runat="server" Font-Bold="True" 
                            Font-Size="Large" Font-Underline="True" ForeColor="#006600">Poliomyelitis:</asp:Label></div>
			...
			<div>
			    ...
			    <div>
			    <div class="entry">
					<p id = "bl">•	It is an infectious viral disease which may cause temporary or permanent localized paralysis as a result of the infection and death of nerve cells in the spinal cord or brain stem.</p>
