<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Ringworm.aspx.cs" Inherits="Ringworm" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Illness: Ringworm</title>
		...
		<div class="post">
			...
			<div>
                        <asp:Label ID="lblViewMembers" runat="server" Font-Bold="True" 
                            Font-Size="Large" Font-Underline="True" ForeColor="#006600">Ringworm:</asp:Label></div>
			...
			<div>
			    ...
			    <div>
			    <div class="entry">
					<p id = "bl">•	It is a contageous fungus skin - disease forming circular patches, especially on the child's scalp</p>
