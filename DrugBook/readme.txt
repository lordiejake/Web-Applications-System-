3D Carousel Menu AS2 FX version 1.0.2.8517

Hello and thank you for using 3D Carousel Menu AS2 FX. By downloading our FlashXML product you have become part of the FX community and we are very pleased to welcome you and wish you a long-lasting FlashXML experience.

The 3D Carousel Menu AS2 FX's features are:
...
- for HTML: www.flashxml.net/3d-carousel-menu.html#swmi-free-install
- for Flash: www.flashxml.net/3d-carousel-menu.html#swmi-free-flash
- for WordPress: www.flashxml.net/3d-carousel-menu.html#swmi-wordpress
- for Joomla: www.flashxml.net/3d-carousel-menu.html#swmi-joomla
- for Facebook: www.flashxml.net/3d-carousel-menu.html#swmi-facebook

By downloading our 3D Carousel Menu AS2 FX you have access to one of the most customizable Flash component on the internet. All of our components are XML driven, so there is no need to use Adobe Flash to change the component's attributes or its assets.
