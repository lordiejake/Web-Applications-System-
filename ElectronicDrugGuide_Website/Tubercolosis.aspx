<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Tubercolosis.aspx.cs" Inherits="Tubercolosis" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Illness: Tubercolosis</title>
		...
		<div class="post">
			...
			<div>
                        <asp:Label ID="lblViewMembers" runat="server" Font-Bold="True" 
                            Font-Size="Large" Font-Underline="True" ForeColor="#006600">Tubercolosis:</asp:Label></div>
			...
			<div>
			   ...
			   <div>
			    <div class="entry">
					<p id = "bl">•	It is an infectious bacterial wasting disease affecting various parts of the body in which tubercles appear on body tissue.</p>
