<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Diphtheria.aspx.cs" Inherits="Diphtheria" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Illness: Diphtheria</title>
		...
		<div class="post">
			...
			<div>
                        <asp:Label ID="lblViewMembers" runat="server" Font-Bold="True" 
                            Font-Size="Large" Font-Underline="True" ForeColor="#006600">Diphtheria:</asp:Label></div>
			...
			<div>
			    <div class="entry">
					<p id = "bl">•	It is an acute infectious  bacterial diseases with inflamation of mucous membrane especially of the throat</p>
