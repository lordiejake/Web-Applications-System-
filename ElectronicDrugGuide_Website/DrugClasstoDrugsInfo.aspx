<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DrugClasstoDrugsInfo.aspx.cs" Inherits="DrugClasstoDrugsInfo" %>
...
<div id="menu">
	...
	<div id="wrapper">
		...
		<div class="post">
			...
			<div style="clear: both;">&nbsp;<asp:Label ID="Label8" runat="server" 
