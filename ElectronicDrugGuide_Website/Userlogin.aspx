...
<div id="menu">
	...
	<div id="wrapper">
		...
		<div class="post">
			...
			<hr />
		    <div class="post">
				<h1 class="title"><a href="#">Login:</h1>
			</div>
			<hr />
			<div>
                        <asp:Label ID="lblViewMembers" runat="server" Font-Bold="True" 
                            Font-Size="Large" Font-Underline="True" ForeColor="#006600">Login here..</asp:Label></div>
			        ...
			        <table>
			            ...
			            <tr>
			                <td>
                                <asp:Label ID="Label4" runat="server" Text="Password:" Font-Bold="True" 
                                    ForeColor="#003300"></asp:Label></td><td>
                                <asp:TextBox ID="TextBox2" runat="server" Width="311px" TextMode="Password"></asp:TextBox>
                            </td>
			            </tr>
			            <tr>
			                <td></td>
			                <td>
			                    ...
			                    <asp:Button ID="Button2" runat="server" Text="Log IN" Width="164px" 
			            ...
			            <tr>
			                <td>
			                 ...
			                 <td>
			                     <asp:LinkButton ID="LinkButton4" runat="server" onclick="LinkButton4_Click1">[Sign up]</asp:LinkButton>
