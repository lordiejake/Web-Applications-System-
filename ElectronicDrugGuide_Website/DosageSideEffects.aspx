<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DosageSideEffects.aspx.cs" Inherits="DosageSideEffects" %>
...
<div id="menu">
	...
	<div id="wrapper">
		...
		<div class="post">
			...
			<hr />
			    <div class="post">
				<asp:Label ID="Label5" runat="server" Text="Dosage and Warnings:" 
                        Font-Bold="True" Font-Size="Large" Font-Underline="True" 
                        ForeColor="#003300"></asp:Label>
			</div>
			<hr />
