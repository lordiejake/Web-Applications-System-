<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DrugClasses.aspx.cs" Inherits="DrugClasses" %>
...
<div id="menu">
	...
	<div id="wrapper">
		...
		<div class="post">
			...
			<hr />
		    <div class="post">
				<h1 class="title"><a href="#">The Following are the Drug Classes:</h1>
			</div>
			<hr />
			<div>
                        <asp:Label ID="lblViewMembers" runat="server" Font-Bold="True" 
                            Font-Size="Large" Font-Underline="True" ForeColor="#006600">List of Drug 
                        Classes:</asp:Label></div>
			    ...
			    <fieldset>
			        <div>
			            <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" 
                            ...
                            ShowFooter="True" Width="630px" onrowcommand="GridView2_RowCommand" 
                            DataKeyNames="DrugclassID">
