...
<div id="menu">
    <ul class="menu">
       ...
       <li><a href="DrugClasses.aspx?" class="parent"><span>Drug Class</span></a></li>
        <li><a href="AllDrugs.aspx?"><span>Drugs</span></a></li>
         <li class="last"><span>
             <asp:LinkButton ID="LinkButton1" runat="server" onclick="LinkButton1_Click">LinkButton</asp:LinkButton></span></li>
    </ul>
</div>
</div>
</div>
	...
	<div id="wrapper">
		...
		<br />
		<div class="post">
				<h2 class="title"><a href="#">Log in Administrator:</a></h2>
				<div>
			            ...
			            <tr>
			                <td>
                                <asp:Label ID="Label4" runat="server" Text="Password:" Font-Bold="True" 
                                    ForeColor="#003300"></asp:Label></td><td>
                                <a href="#">
                                <asp:TextBox ID="TextBox2" runat="server" Width="314px" TextMode="Password"></asp:TextBox>
				</a>
                            </td>
			            </tr>
			            <tr>
