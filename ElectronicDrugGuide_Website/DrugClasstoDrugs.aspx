<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DrugClasstoDrugs.aspx.cs" Inherits="DrugClasstoDrugs" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Drugs Class-- Medicines</title>
...
<div id="menu">
	...
	<div id="wrapper">
					...
					<br />
					    <div>
					            <table>
					                  ...
					                  <tr>
					                        <td><asp:Label ID="AdminStatus" runat="server" ForeColor="#D6D6D6"></asp:Label> 
                                            </td>
					                  </tr>
					            </table>
					    </div>
		...
		<div class="post">
			...
			<hr />
		    <div class="post">
				<h1 class="title"><a href="#">DrugClass Category</h1>
			</div>
			<div>
			...
			<div>
			    ...
			    <asp:GridView ID="GridView5" runat="server" AutoGenerateColumns="False" 
                    CellPadding="4" ForeColor="#333333" GridLines="None" Width="632px" 
